export const categories = [
  ...
  { name: "Forklifts", slug: "forklifts", description: "Used Japanese forklifts and warehouse handling equipment.", image: "/forklift-warehouse.jpg" },
...
export const products = [
  { name: "Toyota 8FG25 Forklift", slug: "toyota-8fg25-forklift", category: "Forklifts", origin: "Japan", condition: "Used", spec: "2.5 ton LPG, 4.3 m mast, solid tyres", moq: "1 unit", packaging: "RoRo or container", status: "Available", image: "/forklift-warehouse.jpg", description: "Export-ready Toyota forklift inspected in Japan, with operating video and condition report available on request.", application: "Warehousing, factories and container yards" },
  { name: "JSW Injection Moulding Machine", slug: "jsw-injection-moulding-machine", category: "Industrial Machinery", origin: "Japan", condition: "Used", spec: "180 ton electric, 2016, controller included", moq: "1 unit", packaging: "Export crating", status: "Inspection available", image: "/forklift-warehouse.jpg", description: "Energy-efficient all-electric moulding machine from a working Japanese facility.", application: "Precision plastic component manufacturing" },
  ...
  { name: "Komatsu PC200 Excavator", slug: "komatsu-pc200-excavator", category: "Construction Equipment", origin: "Japan", condition: "Used", spec: "20 ton class, 2018, 5,800 hours", moq: "1 unit", packaging: "RoRo", status: "Under offer", image: "/port-logistics.jpg", description: "Well-maintained crawler excavator with inspection support and shipment coordination.", application: "Construction, mining and earthmoving" },
...
export const opportunities = [
  ["Used Toyota forklifts", "Japan", "East Africa", "2 units", "Open"],
  ["PVC tarpaulin rolls", "India", "West Africa", "20,000 m", "Quoting"],
  ["Injection moulding machines", "Japan", "Middle East", "1 line", "Inspection ready"],
  ["PP woven bags", "India", "Southern Africa", "100,000 bags", "Open"],
  ["Used excavators", "Japan", "Southeast Asia", "3 units", "Limited"],
...
export const suppliers = [
  { name: "Kansai Industrial Equipment Co.", country: "Japan", categories: ["Forklifts", "Industrial Machinery"], markets: "Africa, Southeast Asia, Middle East", description: "Licensed exporter of inspected used material-handling and factory equipment.", verified: true },
  ...
  { name: "Chubu Auto Recyclers", country: "Japan", categories: ["Auto Parts"], markets: "UAE, Africa, Caribbean", description: "Traceable used engines and automotive components from licensed recycling yards.", verified: true },
];

export const articles = [
  { title: "Japan’s used machinery export market: what buyers should verify", slug: "japan-used-machinery-export-guide", category: "Japan Export", date: "2026-07-11", excerpt: "A practical checklist for inspection records, operating hours, dismantling and export documentation.", image: "/forklift-warehouse.jpg" },
